...
namespace NineXCook.Migrations
{
    ...
    [Migration("20240826151526_criarBanco")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "ddf093a6-6cb5-4ff7-9a64-83da34aee005",
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "a4a4d085-41fc-4d8c-996f-9f5e1e0dd9e3",
                            Email = "admin@NineXCook.com",
                            EmailConfirmed = true,
                            LockoutEnabled = false,
                            NormalizedEmail = "ADMIN@NINEXCOOK.COM",
                            NormalizedUserName = "ADMIN",
                            PasswordHash = "AQAAAAIAAYagAAAAENnboTIyQwcio9HcLKQEUbr3kOvMpUdollrW+OTjgJzOPXm/ow/t1+3K1fE1Vsq7zQ==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "54ae9752-a4cc-4a94-8b7a-dbd3984a6af8",
            ...
            modelBuilder.Entity("NineXCook.Models.Categoria", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("NineXCook.Models.Comentario", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("NineXCook.Models.Ingrediente", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("NineXCook.Models.Receita", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("NineXCook.Models.ReceitaIngrediente", b =>
                {
                    b.Property<int>("ReceitaId")
                        .HasColumnType("int")
                        .HasColumnOrder(1);
            ...
            modelBuilder.Entity("NineXCook.Models.Usuario", b =>
                {
                    b.Property<string>("UsuarioId")
                        .HasColumnType("varchar(255)");
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DataNascimento = new DateTime(2006, 11, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
            ...
            modelBuilder.Entity("NineXCook.Models.Comentario", b =>
                {
                    b.HasOne("NineXCook.Models.Receita", "Receita")
                        .WithMany()
                        .HasForeignKey("ReceitaId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("NineXCook.Models.Usuario", "Usuario")
                        .WithMany()
            ...
            modelBuilder.Entity("NineXCook.Models.Receita", b =>
                {
                    b.HasOne("NineXCook.Models.Categoria", "Categoria")
                        .WithMany()
            ...
            modelBuilder.Entity("NineXCook.Models.ReceitaIngrediente", b =>
                {
                    b.HasOne("NineXCook.Models.Ingrediente", "Ingrediente")
                        .WithMany("Receitas")
